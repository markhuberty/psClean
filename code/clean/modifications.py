############################
## Author: Mark Huberty, Amma Serwaah
## Date Begun: 1 January 2013
## Purpose: Provide specific utilities for formatting PATSTAT data for use in dedupe
...
def str_findall(strng, val):
    """
    Returns the starting index of val for all instances of val in strng
    """
...
def split_multi_names(multiname, name_delim=','):
    """get list of separated names; assumes multi-name fields are comma-separated """
    names = multiname.split(name_delim)
